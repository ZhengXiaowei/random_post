<template>
    <div class="reply-user-page">
        <div class="reply-title">
            <p>回复{{ userName }}：{{ replyContent }}</p>
        </div>
        <div class="reply-content">
            <mu-text-field label="回复内容" class="reply-text-ipts" :hintText="'请输入要回复'+userName+'的内容'" fullWidth labelFloat multiLine :rows="6" :rowsMax="8" v-model="text"/>
...
export default {
    ...
    created() {
        ...
        this.replyContent = this.$route.query.c
